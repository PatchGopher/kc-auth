...
export const keycloak = new arctic.KeyCloak(`${env.KEYCLOAK_URL}/realms/${env.KEYCLOAK_REALM}`, "app", env.KEYCLOAK_CLIENT_SECRET, "http://localhost:8100/login/keycloak/callback");
